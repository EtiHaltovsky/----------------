import React, { useState, useEffect } from 'react';
  ...
  const RecipientPersonalArea = ({ recipientId }) => {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/volunteers/previous?volunteerId=${recipientId}`)
          .then(response => {
    ...
    axios.get(`/api/volunteers/next?volunteerId=${recipientId}`)
      .then(response => {
...
export default RecipientPersonalArea;
